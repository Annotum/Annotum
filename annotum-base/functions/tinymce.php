...
function anno_load_editor($content, $editor_id, $settings = array()) {
	...
	$custom_elements = array(
		...
		// tinymce 4.x+ no longer supports tinymce.html.Schema modifiction in plugin init (old way)
		'PARA',
		'CAP',
		'LABEL',
		'LIST',
...
add_filter( 'the_editor_content', 'anno_remove_editor_content_filters_43', 0 );
...
function anno_get_dtd_valid_elements() {
	...
	return apply_filters('anno_valid_dtd_elements', $processed_tags);
}
